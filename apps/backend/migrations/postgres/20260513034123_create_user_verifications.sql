...
CREATE TABLE IF NOT EXISTS user_verifications (
    ...
    CONSTRAINT user_verifications_kind_check CHECK (
        kind IN ('email', 'password_reset')
    ),
    CONSTRAINT user_verifications_user_fk FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);
